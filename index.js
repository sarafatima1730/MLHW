async function run_hw3_regression() {
    // 1. ⚠️ PASTE YOUR REGRESSION SCALER VALUES FROM COLAB ⚠️
...
async function run_hw3_classification() {
    // 1. ⚠️ PASTE YOUR CLASSIFICATION SCALER VALUES FROM COLAB ⚠️
    const MEANS = [/* PASTE YOUR 30 MEAN VALUES HERE */];
    const SCALES = [/* PASTE YOUR 30 SCALE VALUES HERE */];
    const N_FEATURES = 30;
